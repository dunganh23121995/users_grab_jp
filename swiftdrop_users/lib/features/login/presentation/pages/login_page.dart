...
import '../../../../core/widget/elevated_async_button.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final AuthenticationCubit authenticationCubit = AuthenticationCubit(loginUseCase: getIt<LoginUseCase>());

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => authenticationCubit,
      child: BlocListener<AuthenticationCubit, LoginState>(
        listener: (context, state) {
          ...
          if (state is LoginFailure) {
            ...
            ScaffoldMessenger.of(
              context,
            ).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context)!.email_invalid)));
          }
        },
        child: Scaffold(
          appBar: AppBar(
            leading: IconButton(
              onPressed: () {
                ...
                if (cubitLanguage.state.language == AppLanguage.japanese) {
                  cubitLanguage.changeLanguage(AppLanguage.english);
                } else {
                  cubitLanguage.changeLanguage(AppLanguage.japanese);
                }
              },
            ...
            child: Padding(
              ...
              child: ListView(
                children: [
                      ...
                      builder: (context, stateLanguage) {
                        return Padding(
                          ...
                          child: DropdownButton<AppLanguage>(
                            value: stateLanguage.language ?? AppLanguage.japanese,
                            items:
                                AppLanguage.values
                                    .map(
                                      (e) => DropdownMenuItem(
                                        value: e,
                                        child: Text(e.getName(), style: Theme.of(context).textTheme.bodySmall),
                                      ),
                                    )
                                    .toList(),
                            onChanged: (newValue) {
                              final cubitLanguage = context.read<LanguageCubit>();
                              cubitLanguage.changeLanguage(newValue ?? AppLanguage.japanese);
                            },
                          ),
                        );
                      },
                  ...
                  Text(AppLocalizations.of(context)!.login, style: Theme.of(context).textTheme.labelLarge),
                  ...
                  TextFieldPassword(
                    ...
                    tooShortErrorText: AppLocalizations.of(context)!.password_need_greater_than_six,
                    emptyErrorText: AppLocalizations.of(context)!.password_need_fill,
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedAsyncButton(
                      onPressed: () => authenticationCubit.login(usernameController.text, passwordController.text),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      style: Theme.of(context).extension<AppButtonThemes>()!.googleButtonTheme,
                      onPressed: () {},
